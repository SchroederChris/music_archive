...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { composer: @piece.composer, drawer: @piece.drawer, number: @piece.number, title: @piece.title }
    end
  ...
  test "should update piece" do
    put :update, id: @piece, piece: { composer: @piece.composer, drawer: @piece.drawer, number: @piece.number, title: @piece.title }
    assert_redirected_to piece_path(assigns(:piece))
  end
